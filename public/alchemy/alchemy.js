(function () {
  ...
  API.prototype.Create = function (instance, api) {
    return {
      ...
      nodes: function () {
        ...
        (nodeMap = arguments[0]),
          (nodeMaps = 2 <= arguments.length ? __slice.call(arguments, 1) : []);
        a = this.a;
      ...
      edges: function () {
        ...
        (edgeMap = arguments[0]),
          (edgeMaps = 2 <= arguments.length ? __slice.call(arguments, 1) : []);
        a = this.a;
  ...
  API.prototype.Get = function (instance, api) {
    return {
      ...
      nodes: function () {
        ...
        (id = arguments[0]),
          (ids = 2 <= arguments.length ? __slice.call(arguments, 1) : []);
        nodeList = [];
        if (id != null) {
      ...
      edges: function () {
        ...
        if (id != null) {
          ...
          edgeList = (function (a) {
            return _.flatten(
              _.filter(a._edges, function (val, key) {
                if (_.contains(allIDs, key)) {
                  return val;
                }
              })
      ...
      clusters: function () {
        ...
        _.each(clusterMap, function (key, value) {
          return (nodesByCluster[value] = _.select(
            this.a.get.allNodes(),
            function (node) {
      ...
      clusterColours: function () {
        ...
        _.each(clusterMap, function (key, value) {
          return (clusterColoursObject[value] = this.a.conf.clusterColours[
            key % this.a.conf.clusterColours.length
          ]);
        });
  ...
  Clustering = (function () {
    function Clustering(instance) {
      ...
      _linkDistancefn = function (edge) {
        ...
        if (
          nodes[edge.source.id]._properties.root ||
          nodes[edge.target.id]._properties.root
        ) {
          return 300;
        } else if (
          nodes[edge.source.id]._properties[this.clusterKey] ===
          nodes[edge.target.id]._properties[this.clusterKey]
        ) {
          return 10;
        } else {
          return 600;
    ...
    Clustering.prototype.identifyClusters = function (a) {
      ...
      return (this.clusterMap = _.zipObject(
        clusters,
        function () {
          _results = [];
          for (
            var _i = 0, _ref = clusters.length;
    ...
    Clustering.prototype.edgeGradient = function (edges) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        if (
          ...
          if (id in Q) {
            ...
            startColour = this.getClusterColour(
              nodes[edge.target.id]._properties[this.clusterKey]
            );
            endColour = this.getClusterColour(
              nodes[edge.source.id]._properties[this.clusterKey]
            );
            Q[id] = {
      ...
      for (ids in Q) {
        ...
        gradient
          .append("svg:stop")
          .attr("offset", "0%")
          .attr("stop-color", Q[ids]["startColour"]);
        _results.push(
          gradient
            .append("svg:stop")
            .attr("offset", "100%")
            .attr("stop-color", Q[ids]["endColour"])
        );
      }
      return _results;
    };
  ...
  Alchemy.prototype.clusterControls = {
    init: function () {
      ...
      if (
        this.a.dash.select("#cluster-key-container").style("display") === "none"
      ) {
        this.a.dash
      ...
      zoomCtrl: function () {
        if (a.conf.zoomControls) {
          a.dash
            ...
            .html(
              "<button id='zoom-reset'  class='btn btn-defualt btn-primary'><i class='fa fa-crosshairs fa-lg'></i></button> <button id='zoom-in'  class='btn btn-defualt btn-primary'><i class='fa fa-plus'></i></button> <button id='zoom-out' class='btn btn-default btn-primary'><i class='fa fa-minus'></i></button>"
            );
      ...
      exports: function () {
        ...
        if (a.conf.exportSVG) {
          ...
          a.dash
            ...
            .attr(
              "style",
              "padding: 0.5em 1em; border-bottom: thin dashed #E89619; color: white;"
            )
            .html(exports_html)
        ...
        init: function () {
          ...
          if (a.conf.nodeTypes) {
            ...
            for (_i = 0, _len = _ref.length; _i < _len; _i++) {
              ...
              nodeTypes +=
                "<li class='list-group-item nodeType' role='menuitem' id='li-" +
                nodeType +
                "' name=" +
                nodeType +
                ">" +
          ...
          if (a.conf.edgeTypes) {
            ...
            for (_j = 0, _len1 = types.length; _j < _len1; _j++) {
              ...
              edgeTypes +=
                "<li class='list-group-item edgeType' role='menuitem' id='li-" +
                edgeType +
                "' name=" +
                edgeType +
                ">" +
        ...
        showNodeFilters: function () {
          ...
          return a.dash.select("#filter-node-header").on("click", function () {
            if (a.dash.select("#node-dropdown").classed("in")) {
              return a.dash
                .select("#filter-node-header>span")
                .attr("class", "fa fa-lg fa-caret-right");
            } else {
              return a.dash
                .select("#filter-node-header>span")
        ...
        edgesToggle: function () {
          return a.dash
            ...
            .on("click", function () {
              if (
                _.contains(
                  _.pluck(_.flatten(_.values(a._edges)), "_state"),
                  "active"
                )
              ) {
                ...
                return _.each(_.values(a._edges), function (edges) {
                  return _.each(edges, function (e) {
                    ...
                    if (
                      source._state === "active" &&
                      target._state === "active"
                    ) {
                      return e.toggleHidden();
                    }
                  });
    ...
    return {
      ...
      nodeMouseOut: function (n) {
        ...
        if (node._state !== "hidden") {
          ...
          if (
            a.conf.nodeMouseOut != null &&
            typeof a.conf.nodeMouseOut === "function"
          ) {
  ...
  Layout = (function () {
    function Layout(instance) {
      ...
      nodes = this.a._nodes;
      this.k = Math.sqrt(
        Math.log(_.size(this.a._nodes)) /
          (conf.graphWidth() * conf.graphHeight())
      );
      ...
      if (conf.cluster) {
        ...
        this._linkStrength = function (edge) {
          if (
            nodes[edge.source.id].getProperties("root") ||
            nodes[edge.target.id].getProperties("root")
          ) {
            return 1;
          } else {
            return 0.9;
    ...
    Layout.prototype.positionRootNodes = function () {
      ...
      if (rootNodes.length === 1) {
        n = rootNodes[0];
        (_ref = [container.width / 2, container.width / 2]),
          (n._d3.x = _ref[0]),
          (n._d3.px = _ref[1]);
        (_ref1 = [container.height / 2, container.height / 2]),
          (n._d3.y = _ref1[0]),
          (n._d3.py = _ref1[1]);
        n._d3.fixed = true;
      } else {
  ...
  Alchemy.prototype.stats = function (instance) {
    ...
    return {
      ...
      nodeStats: function () {
        ...
        nodeStats =
          "<li class = 'list-group-item gen_node_stat'>Number of nodes: <span class='badge'>" +
          allNodes +
          "</span></li> <li class = 'list-group-item gen_node_stat'>Number of active nodes: <span class='badge'>" +
          activeNodes +
          "</span></li> <li class = 'list-group-item gen_node_stat'>Number of inactive nodes: <span class='badge'>" +
          inactiveNodes +
          "</span></li></br>";
        if (a.conf.nodeTypes) {
          ...
          for (_i = 0, _len = _ref.length; _i < _len; _i++) {
            ...
            nodeTypes +=
              "<li class = 'list-group-item nodeType' id='li-" +
              nodeType +
              "' name = " +
              caption +
              ">Number of <strong style='text-transform: uppercase'>" +
              caption +
              "</strong> nodes: <span class='badge'>" +
              nodeNum +
              "</span></li>";
      ...
      edgeStats: function () {
        ...
        edgeStats =
          "<li class = 'list-group-item gen_edge_stat'>Number of relationships: <span class='badge'>" +
          allEdges +
          "</span></li> <li class = 'list-group-item gen_edge_stat'>Number of active relationships: <span class='badge'>" +
          activeEdges +
          "</span></li> <li class = 'list-group-item gen_edge_stat'>Number of inactive relationships: <span class='badge'>" +
          inactiveEdges +
          "</span></li></br>";
        if (a.conf.edgeTypes) {
          ...
          for (_i = 0, _len = edgeKeys.length; _i < _len; _i++) {
            ...
            edgeTypes +=
              "<li class = 'list-group-item edgeType' id='li-" +
              edgeType +
              "' name = " +
              caption +
              ">Number of <strong style='text-transform: uppercase'>" +
              caption +
              "</strong> relationships: <span class='badge'>" +
              edgeNum +
              "</span></li>";
      ...
      insertSVG: function (element, data) {
        ...
        if (data === null) {
          return a.dash
            ...
            .html(
              "<br><h4 class='no-data'>There are no " +
                element +
                "Types listed in your conf.</h4>"
            );
        } else {
  ...
  Alchemy.prototype.defaults = {
    ...
    graphHeight: function () {
      if (
        d3.select(this.divSelector).node().parentElement.nodeName === "BODY"
      ) {
      ...
      edgeWalk: function (edge) {
        ...
        if (!a.conf.curvedEdges) {
          ...
          if (!a.conf.directedEdges) {
            return (
              "M " + sourcePadding + " 0 L " + (distance - targetPadding) + " 0"
            );
          } else {
            ...
            return (
              ...
              sourcePadding +
              " 0 L " +
              (distance - targetPadding - headLength) +
              " 0 l 0 2 l " +
              headLength / 2 +
              " -2 l " +
              -headLength / 2 +
          ...
          cy = g1 * cx + c1;
          arcRadius = Math.sqrt(
            square(cx - startAttachX) + square(cy - startAttachY)
          );
          ...
          if (!a.conf.directedEdges) {
            return (
              "M " +
              startTangent(-shaftRadius) +
              " A " +
              (arcRadius - shaftRadius) +
              ", " +
              (arcRadius - shaftRadius) +
              " 0 0 0 " +
              endTangent(-shaftRadius)
            );
          } else {
            return (
              "M " +
              ...
              endTangent(-shaftRadius) +
              " L " +
              endTangent(-headRadius) +
              " L " +
              endNormal(headLength) +
              " L " +
              endTangent(headRadius) +
              " L " +
              endTangent(shaftRadius) +
    ...
    return {
      ...
      node: {
        ...
        populate: function (node) {
          ...
          typedStyle = _.assign(
            _.cloneDeep(defaultStyle),
            conf.nodeStyle[nodeType]
          );
  ...
  Editor = (function () {
    ...
    Editor.prototype.startEditor = function () {
      ...
      editor_interactions = editor
        .select("#element-options ul #editor-interactions")
        .on("click", function () {
          return d3
            .select(this)
            .attr("class", function () {
    ...
    Editor.prototype.nodeEditor = function (n) {
      ...
      d3.selectAll("#add-prop-key, #add-prop-value, .property").on(
        "keydown",
        function () {
  ...
  EditorInteractions = (function () {
    ...
    EditorInteractions.prototype.addNodeDragging = function (d, i) {
      ...
      alchemy.vis
        .select("#dragline")
        .attr("x1", this.sourceNode.x)
        .attr("y1", this.sourceNode.y)
        .attr("x2", x2coord)
        .attr("y2", y2coord)
    ...
    EditorInteractions.prototype.deleteSelected = function (d) {
      switch (d3.event.keyCode) {
        ...
        case 46:
          if (
            !(
              d3.select(d3.event.target).node().tagName ===
              ("INPUT" || "TEXTAREA")
            )
          ) {
            d3.event.preventDefault();
  ...
  EditorUtils = (function () {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        if (node_data != null) {
          ...
          for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
            edge = _ref1[_j];
            alchemy._edges = _.omit(
              alchemy._edges,
              "" + edge.id + "-" + edge._index
            );
            alchemy.edge = alchemy.edge.data(
              _.map(alchemy._edges, function (e) {
                return e._d3;
              }),
              function (e) {
                return e.id;
          ...
          alchemy.node = alchemy.node.data(
            _.map(alchemy._nodes, function (n) {
              return n._d3;
            }),
            function (n) {
              return n.id;
    ...
    EditorUtils.prototype.addNode = function (node) {
      ...
      return (alchemy.node = alchemy.node.data(
        _.map(alchemy._nodes, function (n) {
          return n._d3;
        }),
        function (n) {
    ...
    EditorUtils.prototype.addEdge = function (edge) {
      ...
      return (alchemy.edge = alchemy.edge.data(
        _.map(alchemy._edges, function (e) {
          return e._d3;
        }),
        function (e) {
  ...
  Alchemy.prototype.Edge = function (instance) {
    ...
    return (Edge = (function () {
      function Edge(edge, index) {
        ...
        this._style =
          conf.edgeStyle[this._edgeType] != null
            ? _.merge(
                _.clone(conf.edgeStyle["all"]),
                conf.edgeStyle[this._edgeType]
              )
            : _.clone(conf.edgeStyle["all"]);
        this._d3 = _.merge(
          {
      ...
      Edge.prototype.getProperties = function () {
        var key, keys, query;
        (key = arguments[0]),
          (keys = 2 <= arguments.length ? __slice.call(arguments, 1) : []);
        if (key == null) {
          key = null;
        }
      ...
      Edge.prototype.remove = function () {
        ...
        if (this.a._nodes[edge._properties.source] != null) {
          _.remove(
            this.a._nodes[edge._properties.source]._adjacentEdges,
            function (e) {
              if (e.id === edge.id) {
                return e;
              }
        ...
        if (this.a._nodes[edge._properties.target] != null) {
          _.remove(
            this.a._nodes[edge._properties.target]._adjacentEdges,
            function (e) {
              if (e.id === edge.id) {
                return e;
              }
  ...
  Alchemy.prototype.Node = function (instance) {
    ...
    return (Node = (function () {
      function Node(node) {
        ...
        this._style = conf.nodeStyle[this._nodeType]
          ? conf.nodeStyle[this._nodeType]
          : conf.nodeStyle["all"];
        this._state = "active";
        this._adjacentEdges = [];
      }
      ...
      Node.prototype.toggleHidden = function () {
        ...
        return _.each(this._adjacentEdges, function (e) {
          ...
          if (
            ...
            e._state === "active" &&
            (sourceState === "hidden" || targetState === "hidden")
          ) {
            return e.toggleHidden();
          }
        });
  ...
  warnings = (function () {
    ...
    warnings.prototype.dataWarning = function () {
      if (
        this.a.conf.dataWarning &&
        typeof this.a.conf.dataWarning === "function"
      ) {
